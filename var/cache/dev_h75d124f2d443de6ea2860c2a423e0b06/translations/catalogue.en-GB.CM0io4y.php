...
$catalogue = new MessageCatalogue('en-GB', array (
  ...
  array (
    ...
    'account.orderContextMenuChangePayment' => 'Change payment',
    'account.orderContextMenuReorder' => 'Reorder',
    'account.orderContextMenuCancel' => 'Cancel',
    'account.editOrder' => 'Edit order',
    'account.editOrderUpdateButton' => 'Update order',
    'account.editOrderBackToAccountButton' => 'Back to your account',
    'account.editOrderBackToOrderButton' => 'Back to your order',
    ...
    'checkout.confirmChoosePayment' => 'Choose payment',
    ...
    'checkout.confirmChooseShipping' => 'Choose shipping',
    'checkout.confirmCurrentPaymentShipping' => 'Current selection:',
    'checkout.confirmSelectionNone' => 'None',
    ...
    'checkout.finishPaymentHeader' => 'The payment for your order was changed to %paymentName%!',
    ...
    'checkout.finishChangePayment' => 'Change Payment',
    'checkout.finishPaymentFailed' => 'Unfortunately, your payment process went wrong. Please change your payment method to finish your order. <a href="%editOrderUrl%">Change Payment</a>',
    ...
    'checkout.customerCommentLabel' => 'Would you like to tell us something about your order?',
    ...
    'listing.filterRatingActiveLabelEnd' => 'star(s)',
 ...
 To complete the registration process, search your email inbox for a confirmation mail and click on the link provided with it.',
    ...
    'footer.includeVat' => '* All prices incl. VAT plus <a data-toggle="modal" href="%url%" data-url="%url%">shipping costs</a> and cash on delivery charges, if not described otherwise',
    'footer.excludeVat' => '* All prices are quoted net of the statutory value-added tax, <a data-toggle="modal" href="%url%" data-url="%url%">shipping costs</a> and possibly delivery charges, if not otherwise described',
    ...
    'cookie.groupStatistical' => 'Statistic',
    'cookie.groupStatisticalDescription' => 'These cookies are used for statistics and shop performance metrics.',
