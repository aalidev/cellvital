...
class __TwigTemplate_18ff9233081fcfd43e10e7c6d77104fd79cc31359de64bbcee5e7af035464162 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["product"] ?? null), "availableStock", [], "any", false, false, false, 52) < twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "minPurchase", [], "any", false, false, false, 52)) && twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "deliveryTime", [], "any", false, false, false, 52)) && twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "restockTime", [], "any", false, false, false, 52))) {
            ...
            <p class=\"delivery-information\">
                ...
                ";
            // line 57
            echo $this->extensions['Shopware\Storefront\Framework\Twig\Extension\SwSanitizeTwigFilter']->sanitize($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("detail.deliveryTimeRestock", ["%restockTime%" => twig_get_attribute($this->env, $this->source,             // line 58
($context["product"] ?? null), "restockTime", [], "any", false, false, false, 58), "%name%" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,             // line 59
($context["product"] ?? null), "deliveryTime", [], "any", false, false, false, 59), "translation", [0 => "name"], "method", false, false, false, 59)]));
            // line 60
            echo "
            </p>
        ";
...
";
    ...
    {
        return array (  230 => 30,  224 => 26,  214 => 25,  201 => 21,  195 => 17,  185 => 16,  172 => 10,  168 => 8,  158 => 7,  147 => 63,  142 => 60,  140 => 59,  139 => 58,  138 => 57,  132 => 53,  130 => 52,  124 => 49,  118 => 45,  116 => 44,  112 => 42,  110 => 41,  109 => 40,  102 => 35,  100 => 34,  97 => 33,  94 => 25,  91 => 24,  88 => 16,  86 => 15,  83 => 14,  80 => 13,  77 => 7,  75 => 6,  71 => 4,  68 => 3,  66 => 2,  47 => 1,);
    }
...
{% endblock %}
", "@Storefront/storefront/component/delivery-information.html.twig", "/var/www/html/sw6/vendor/shopware/platform/src/Storefront/Resources/views/storefront/component/delivery-information.html.twig");
    }
}
